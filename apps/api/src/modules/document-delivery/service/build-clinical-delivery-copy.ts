...
const CATEGORY_LABELS: Readonly<Record<DocumentCategoryValue, { id: string; en: string }>> = {
  ...
  KIA_BOOK_COPY: { id: 'salinan buku KIA', en: 'KIA book copy' },
  PARTOGRAPH: { id: 'partograf', en: 'partograph' },
  FAMILY_PLANNING_BOOK: { id: 'buku peserta KB', en: 'family planning book' },
