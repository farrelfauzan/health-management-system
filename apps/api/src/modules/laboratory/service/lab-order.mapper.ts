...
export class LabOrderMapper {
  ...
  private toOrderHeader(record: Omit<LabOrderRecord, 'items' | 'specimens'>) {
    return {
      ...
      orderedById: record.orderedById ?? undefined,
      orderedByName: record.orderedByName ?? undefined,
      externalRequesterName: record.externalRequesterName ?? undefined,
      externalRequesterFacility: record.externalRequesterFacility ?? undefined,
      status: record.status,
      priority: record.priority,
