...
const GATED_CONTROLLERS: Readonly<Record<string, FeatureKey>> = {
  ...
  // P18-T05. The rendered report, read under the same feature as the order it renders.
  LabReportController: 'laboratory',
...
const NEVER_GATED_CONTROLLERS: readonly string[] = [
  ...
  // P23-T04. MetaKlinik's own connector, not a module the clinic bought:
