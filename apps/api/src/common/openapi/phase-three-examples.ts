...
export const PHASE_THREE_EXAMPLES = {
      ...
      permissions: [
        {
          ...
          action: 'read',
          scope: 'ANY',
          description: optionalExample('Read all invoices'),
          requires: [],
          effects: { requiresMfa: false, portal: null, isClinicalContent: false },
        },
        {
          id: 'dddddddd-dddd-4ddd-8ddd-dddddddddddf',
          permissionKey: 'invoice.write:any',
          resource: 'Invoice',
          action: 'write',
          scope: 'ANY',
          description: optionalExample('Create and edit invoices'),
          requires: ['invoice.read:any'],
          effects: { requiresMfa: false, portal: null, isClinicalContent: false },
        },
      ],
    },
  ...
  admin: {
    ...
    // P16-T41. The counts are what the super admin confirms against: shared
    // documents survive for their recipients, unshared ones are deleted on
    // the date shown.
    offboardingPreview: {
      userId,
  ...
  patient: {
    createRequest: {
      ...
      emergencyContactPhone: '+628123456700',
      allergies: [
        { substance: 'Penicillin', reaction: 'Urticaria and swelling', severity: 'SEVERE' },
      ],
      ownerUserId: userId,
      doctorIds: [doctorId],
    },
  ...
  doctor: {
    ...
    detail: {
      ...
      patients: [{ id: patientId, assignmentId, mrn: patient.mrn, fullName: patient.fullName }],
    },
  },
  assignment: {
