 ...
 * penetapan number below follows the district letter pattern but is a
 * placeholder; the names are invented.
 */
...
export const DOCTOR_AUTHORITY_EXAMPLES = {
  ...
  revokedItem: {
    ...
    revokeReason: 'Penetapan withdrawn by the district health office',
    createdAt: '2026-01-02T03:00:00.000Z',
  ...
  createRequest: {
    ...
    validFrom: '2026-01-01',
    validUntil: '2027-12-31',
    grantDocumentStorageKey: `doctor-authorities/${DOCTOR_ID}/9b1deb4d-3b7d-4bad-9bdd-2b0d7b3dcb6d.pdf`,
  },
  updateRequest: {
    grantReference: '440/124/2026',
    validUntil: '2028-12-31',
  },
  revokeRequest: {
    reason: 'Penetapan withdrawn by the district health office',
  },
  uploadUrlRequest: {
