...
const DEFAULT_KYC_BASE_URL = 'https://api-satusehat-stg.dto.kemkes.go.id/kyc/v1';
...
export function resolveSatusehatConfig(configService: ConfigService): SatusehatConfig {
  ...
  return {
    ...
    kycBaseUrl: readBaseUrl(configService, 'SATUSEHAT_KYC_BASE_URL', DEFAULT_KYC_BASE_URL),
