...
/**
 * Notion connector (P23-T02). Resolves the environment-only settings once, at
 * boot: the factory runs while Nest builds the injector, so a half-set or
 * malformed credential kills the process with a readable message instead of
 * surfacing as a 401 at the first bug report.
 *
