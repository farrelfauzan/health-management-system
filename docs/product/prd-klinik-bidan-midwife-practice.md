...
- **Records:** Buku KIA, kartu ibu, kohort ibu, register ibu, register bayi, MTBS charts, KPSP forms, informed consent, referral forms; monthly KIA report to the puskesmas coordinator, rolled into PWS KIA; e-Kohort KIA where the district uses it.
- **Money:** BPJS pays non-capitation per service (Permenkes 3/2023 Pasal 19–22, pp. 13–16, batang tubuh, not lampiran; verified by P25-T13): antenatal Rp70.000 per visit for a bidan jejaring, normal delivery Rp1.200.000 at a non-puskesmas FKTP with a doctor on the team or **Rp800.000** for a team of two nakes with no doctor, postpartum Rp50.000 per visit (four payable). A PMB claims as a *bidan jejaring* through its induk FKTP, which files through BPJS eClaim; there is no PCare web-service route for these claims.
...
- No e-Kohort KIA sync, import file or export-matching-import in this phase. P25-T11 found no public interface; the Kemenkes-stated integration path is SATUSEHAT ANC/PNC. Revisit as a new ticket only if Kemenkes ships the SATUSEHAT-to-e-Kohort feed or the pilot Dinkes provides a documented DHIS2 import for private clinics.
...
| FR-RPT-04 | SHOULD | **Decided by P25-T11 (15 September 2026): no e-Kohort KIA interface.** e-Kohort KIA publishes no API and no import format (`docs/ops/e-kohort-kia-spike.md` §2). The monthly KIA report and the kohort registers are delivered as exports only (FR-RPT-01..03). The kohort-ibu register export uses the Kemenkes 2020 Register Kohort Ibu column order (53 columns) unless Q11 records a different pilot layout. The recognised electronic path to the Ministry is the SATUSEHAT ANC and PNC modules with the K-visit (K1A, K1M, K2..K6) and KF (KF1..KF4) `Encounter.identifier` values on every visit. |

### E13 — BPJS bidan jejaring claims (Gap)

Basis: Permenkes 3/2023 Pasal 19–22 (pp. 13–16) standard tariffs; network midwife claims filed by the induk FKTP. Permenkes 28/2014 lampiran p. 31 point 8 sets the 10th of the following month, the induk's PKS may set its own date, and the binding expiry is six months after the service (Perpres 82/2018 Pasal 77, Peraturan BPJS 7/2018 Pasal 40). Verified by P25-T13: `docs/ops/bpjs-bidan-jejaring-claims-spike.md`.

| ID | Priority | Requirement |
|---|---|---|
| FR-JKN-01 | MUST | **Done by P25-T13 (15 September 2026).** Our PCare integration sends no tindakan or tariff, and no PCare web-service route exists for these claims: the induk files through BPJS eClaim, and the PMB may hold its own eClaim bidan-jejaring login under the induk's code. Tariffs (Permenkes 3/2023, batang tubuh): ANC Rp70.000 per visit on the 6-visit schedule; delivery Rp1.200.000 (FKTP selain puskesmas, team with a doctor) or **Rp800.000** (team of two nakes with no doctor, uncomplicated delivery, Pasal 20 ayat (1)–(2), p. 14); PNC Rp50.000 per visit, four payable; pra rujukan at most Rp200.000; KB Rp105.000 (AKDR) / Rp105.000 (implan) / Rp20.000 (suntik) / Rp125.000 (komplikasi) / Rp370.000 (MOP). Supporting documents (Peraturan BPJS 7/2018 Pasal 12–14, pp. 10–12): FPK, rekap, kuitansi bermaterai and SPTJM signed by the Pimpinan FKTP, bukti pelayanan; ANC/PNC/pra rujukan a Buku KIA page copy or signed kartu ibu (pra rujukan adds the referral letter); delivery adds a partograf copy and the surat keterangan kelahiran; KB adds the buku peserta KB and, for implant/IUD/MOP, signed consent. The recap for the induk is P25-T16. |
...
| Q11 | Which monthly report layout do the pilot puskesmas accept, and is it the same across districts? | Product, pilot bidan | E12 | **STILL UNKNOWN** — owner Product via the pilot bidan, requested 2026-09-15: blank or anonymised form, headers verbatim, paper/Excel/system, second district. Provisional, clearly labelled: a district open-data LB3-KIA Maternal sheet (antenatal lab block, 36 numbered columns) and the PWS-KIA 2010 indicator list, both in research doc §7. The Kemenkes "Kohort Ibu 2020" register PDF was unreachable (503) on the research day. Also asks whether the PMB holds an e-Kohort nakes account and whether the Dinkes accepts SATUSEHAT ANC/PNC submission in place of e-Kohort entry (P25-T11 Q5, owner Product, requested 2026-09-15) |
| Q12 | Does a pilot PMB claim BPJS itself or through an induk clinic, and which clinic? | Product, pilot bidan | E13 | **STILL UNKNOWN** — owner Product, requested 2026-09-15. P25-T13 widened it to three sub-questions: (a) which induk, and is it government-owned; (b) does the PMB hold its own eClaim bidan-jejaring login; (c) the claim filing date in the induk's PKS. `docs/ops/bpjs-bidan-jejaring-claims-spike.md` |
| Q14 | Does the official PCare catalogue publish any tindakan or claim write endpoint? | Product, induk kantor cabang | FR-JKN-02 | **STILL UNKNOWN** — the Trust Mark portal was unreachable on 2026-09-15; ask the induk's BPJS kantor cabang. P25-T13 found none in the published REST surface |
