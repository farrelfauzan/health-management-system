...
function SidebarMenuBadge({
  ...
  return (
    <div
      ...
      className={cn(
        "pointer-events-none absolute right-1 flex h-5 min-w-5 items-center justify-center rounded-md bg-sidebar-accent px-1 text-center text-xs leading-none font-medium text-sidebar-accent-foreground tabular-nums select-none",
